...
layout = dbc.Col([
                ...
                html.P("By Ju", className="text-info"),
                html.Hr(),
    # Seção PERFIL ------------------
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(placeholder="Ex.: dividendos da bolsa, salário...", id="txt-receita"),
                            ], width=6),
                            dbc.Col([
                                dbc.Label("Valor: "),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(placeholder="Ex.: Gasolina, aluguel...", id="txt-despesa"),
                            ], width=6),
                            dbc.Col([
                                dbc.Label("Valor: "),
